...
const char* ssid = "Orange_2.4G"; //--> Nama Wifi / SSID.
const char* password = "0829887580"; //-->  Password wifi .
//----------------------------------------
...
String GAS_ID = "AKfycbxNdF-RrcngDx4v4Dplrypu0Nmh_f6uEBn1nn6bhVfB022WcZE"; //--> spreadsheet script ID
